...
**Синтаксис розширення** `...`  розпаковує *ітеративний об'єкт* до списку аргументів  
...
яке складається з *запису середовища* (зберігає локальні змінні як властивості та ін) та  
посилання на *зовнішнє лексичне середовище* (або null).  
